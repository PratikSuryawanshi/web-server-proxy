            ...
            if (typeof (cache.get(req.method + ' ' + req.url)) !== 'undefined' && req.method !== 'POST') {
                ...
                var remoteRequest = http.request(reqOptions, function (response) {
                    ...
                    response.on('end', function () {
                        ...
                        var httpHostName = "http://"+reqOptions.host;
                        var httpsHostName = "https://"+reqOptions.host;
                        
                        var exp1 = new RegExp(httpHostName, 'g');
                        var exp2 = new RegExp(httpsHostName, 'g');
                        
                        respDat = respDat.replace(exp1, "");
                        respDat = respDat.replace(exp2, "");
